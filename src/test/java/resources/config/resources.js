function() {
    const paths = {
        businessFeatureClassPath: 'classpath:/apps/%s/business/%s/%s.feature',
        ...
        driverUpdateScriptPath: 'classpath:/common/scripts/driverUpdate.js'
    };
    ...
    var resolvePath = function resolvePath(pathTemplate, app, name, platform = "") {
        ...
        if (!Java.type('common.helper.FileHelper').exists(filePath)) {
